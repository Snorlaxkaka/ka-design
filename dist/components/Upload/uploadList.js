...
export var UploadList = function (props) {
    ...
    return (React.createElement("ul", { className: "curry-upload-list" }, fileList.map(function (item) {
        return (React.createElement("li", { className: "curry-upload-list-item", key: item.uid },
