...
export var Input = function (props) {
    ...
    // 根据属性计算不同样式
    var classes = classNames('curry-input-wrapper', className, (_a = {},
    ...
    return (React.createElement("div", { className: classes, style: style },
        prepend && React.createElement("div", { className: "curry-input-group-prepend" }, prepend),
        icon && (React.createElement("div", { className: "icon-wrapper" },
            React.createElement(Icon, { icon: icon, title: "title-".concat(icon) }))),
        React.createElement("input", __assign({ className: "curry-input-inner", disabled: disabled }, restProps)),
        append && React.createElement("div", { className: "curry-input-group-append" }, append)));
};
